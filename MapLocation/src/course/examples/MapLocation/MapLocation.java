...
public class MapLocation extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// savedInstanceState is a data structure. 
		// whatever android saved from the last time the activity was run 
		// 
		super.onCreate(savedInstanceState);
		
		// Set content view sets the layout for this application
		setContentView(R.layout.main);

		// Initialize UI elements
		// we get elements with findViewById
		// capture and retain references to UI elements
